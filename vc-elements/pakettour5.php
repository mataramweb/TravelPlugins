<?php
class model5 extends WPBakeryShortCode {     
    // Element Init
    function __construct() {
        add_action( 'init', array( $this, 'mapping_v5' ) );
        add_shortcode( 'package_v5', array( $this, 'html_v5' ) );
    }     
    // Element Mapping
    public function mapping_v5() {		
...
foreach( $categories as $category ){
 ...
 // Map the block with vc_map()
        vc_map( 
            ...
            array(
                'name' => __('Paket Tour V-5', 'text-domain'),
                'base' => 'package_v5',
 ...
 $item = 	      '<div class="col-md-'.$size.'">
						<div class="thumbnail2 box-shadow">
							<div href="#"><img src="'.$featured_img_url.'" alt="#" class="gambarpaket2">
									...
									<div class="deskrip1">
											<div class="judul-utama"><h4><a href="'.$href.'">'.$title.'</a></hW></div>
												<div class="attribut-paket">						
														<div class="col-md-6 col-xs-6"><a class="btn" href="'.$href.'">Read More <i class="fa fa-arrow-right" aria-hidden="true"></i></a><br></div>
														<div class="col-md-6 col-xs-6">
														<i class="fa fa-star" aria-hidden="true" style="color:#F48024"></i>
														<i class="fa fa-star" aria-hidden="true" style="color:#F48024"></i>
														<i class="fa fa-star" aria-hidden="true" style="color:#F48024"></i>
														<i class="fa fa-star" aria-hidden="true" style="color:#F48024"></i>
														<i class="fa fa-star" aria-hidden="true" style="color:#F48024"></i>
